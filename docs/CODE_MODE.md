...
или клавишей `1` на экране выбора:

![Экран выбора режима](img/picker.svg)

Здесь редактор, живой разбор расписания прямо в номерах строк, и три способа
принести файл: положить в рабочий каталог, открыть проводником, вставить
командой.
