...
# — человеческая, для баннера и подписей: «0.7.0a1» в шапке читается как
# опечатка, а «0.7 alpha» сразу говорит, что инструмент ещё не устоялся.
#
# 0.7 — переписанный интерфейс: три полноэкранных режима на Textual вместо
# одного окна на curses. Альфа, потому что интерфейс обкатан на одном
# терминале и раскладки ещё будут меняться.
__version__ = "0.7.0a1"
VERSION_LABEL = "0.7 alpha"
