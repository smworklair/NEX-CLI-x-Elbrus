...
или клавишей `4` на экране выбора. Здесь редактор, живой разбор расписания
...
лежит в `vendor/`). *Важная оговорка, а не документация задним числом:*
несмотря на подпись, поиск сейчас находит **только файлы**, не папки — так
устроен код, а не заявлено намеренно. Если ищете папку по имени, зайдите в
неё обычной навигацией, а не через строку поиска.
