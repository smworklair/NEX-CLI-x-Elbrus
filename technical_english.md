# Технический английский — словарь по сегодняшнему вечеру

Не общий английский, а конкретно то, что реально встречалось в ошибках/логах
за один вечер. Каждое слово — с примером ИЗ СЕГОДНЯШНЕГО контекста, чтобы
запомнилось через ситуацию, а не абстрактно.
...
**Как этим пользоваться.** В следующий раз, прежде чем кидать мне ошибку —
попробуйте сами найти в ней 2-3 слова отсюда и понять фразу целиком. Это
покрывает большую часть того, что реально встречается изо дня в день —
дальше просто накапливается за счёт повторения, без отдельной учёбы.
